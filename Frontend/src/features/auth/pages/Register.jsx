      ...
      <div className="w-full max-w-7xl h-full lg:h-[94vh] grid grid-cols-1 lg:grid-cols-12 bg-white shadow-xl sm:rounded-2xl border border-slate-100 overflow-hidden">
        ...
        <div className="lg:col-span-7 p-5 sm:p-8 flex flex-col justify-center bg-white overflow-y-auto">
          <div className="max-w-xl mx-auto w-full">
            ...
            {/* Error Message Box */}
            {error && (
              <div className="mb-3 p-2.5 bg-red-50 border border-red-200 text-red-600 text-xs rounded-lg">
                {error}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full mt-4 py-2.5 px-4 bg-sky-600 hover:bg-sky-700 text-white font-medium text-xs rounded-xl shadow-md shadow-sky-600/20 active:scale-[0.99] transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
              >
