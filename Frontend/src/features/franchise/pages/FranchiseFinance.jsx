...
const FranchiseFinance = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAF6EE] font-light text-slate-700 p-4 md:p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        {/* Back to Dashboard Navigation Button */}
        <div>
          <Link
            to="/franchise/dashboard"
            className="inline-flex items-center gap-2 text-xs font-normal text-slate-600 hover:text-[#D92344] bg-white/80 border border-[#E3C279]/30 px-3.5 py-2 rounded-xl shadow-xs transition hover:bg-white"
          >
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-white/80 backdrop-blur-md p-6 rounded-2xl border border-[#E3C279]/30 shadow-sm gap-4">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className={`px-5 py-2.5 rounded-xl text-xs font-normal transition-all shadow-md ${activePendingWithdrawal || !bankDetailsConfigured
            ...
            <div className="flex bg-[#FAF6EE] p-1 rounded-xl border border-[#E3C279]/30 text-xs font-normal">
              {["daily", "weekly", "monthly", "yearly"].map((filter) => (
                <button
                  ...
                  className={`px-3 py-1 rounded-lg capitalize transition-all ${analyticsFilter === filter
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-3.5 px-6 whitespace-nowrap">
                          <span
                            className={`px-2.5 py-1 rounded-full text-[10px] font-normal border ${isCredit
                        ...
                        <td
                          className={`py-3.5 px-6 text-right whitespace-nowrap font-normal ${isCredit ? "text-emerald-600" : "text-[#D92344]"
                            }`}
                        >
                          {isCredit ? "+" : "-"}₹
