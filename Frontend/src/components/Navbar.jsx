    ...
    <nav className="w-full bg-black/90 text-white border-b border-white/10 sticky top-0 z-50 backdrop-blur-md">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            <button
              ...
              className="relative p-2.5 text-zinc-300 hover:text-white hover:bg-white/10 rounded-full transition-all duration-300 group"
            >
              <svg className="w-6 h-6 transition-transform group-hover:scale-105" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden border-t border-white/10 bg-black/95 px-6 pt-4 pb-6 space-y-4">
          <a href="#about" className="block text-zinc-400 hover:text-white text-sm font-medium uppercase tracking-widest">
            About Us
          </a>
          <a href="#vision" className="block text-zinc-400 hover:text-white text-sm font-medium uppercase tracking-widest">
            Our Vision
          </a>
          <a href="#contact" className="block text-zinc-400 hover:text-white text-sm font-medium uppercase tracking-widest">
            Contact Us
          </a>
